		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Empleados",
									"targetURL": "#nryzyemployees-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nryzyemployees-display": {
								"semanticObject": "nryzyemployees",
								"action": "display",
								"description": "Empleados SAPUI5",
								"title": "Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nryzy.employees",
									"url": sap.ui.require.toUrl("nryzy/employees")
								}
							}
						}
					}
